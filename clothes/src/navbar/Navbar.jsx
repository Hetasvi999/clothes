        ...
        <div className="bg-white py-3">
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between">
                    ...
                    <img src="/assets/img/SHOP.CO.png" alt="Logo" className="sm:h-7" />

                    <ul className="hidden lg:flex gap-6">
                        <li><Link className="text-black font-semibold hover:text-amber-950">Shop</Link></li>
                    ...
                    <div className="flex items-center gap-6 text-[22px] text-black">
                        ...
                        <FaRegUserCircle className="hover:text-blue-600 cursor-pointer" />
                    ...
                    <div className="lg:hidden mt-4">
                      ...
                      <li><Link className="block text-black font-semibold hover:text-amber-950">Shop</Link></li>
                        ...
                        <li><Link className="block text-black font-semibold hover:text-amber-950">Best Deals</Link></li>
                            <input type="text" placeholder="Search for products" className="w-full mt-2 px-4 py-2 border border-gray-300 rounded-full text-sm bg-gray-100 outline-none"
                            />
                        </ul>
                    </div>
                )} */}
